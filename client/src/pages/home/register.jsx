...
const Register = ({ isOpen, setIsOpen }) => {
    ...
    const { register, isSuccess, user, message, isLoading } = useAuthStore();
    ...
    useEffect(() => {
        if (
            ...
            setIsOpen(false);
            navigate("/dashboard");
        } else if (!isSuccess && message && !message.includes("OAuth")) {
            toast.error(message);
        }
    }, [isSuccess, user, message, setIsOpen, navigate]);
    ...
    useEffect(() => {
        setPasswordStrength({
            ...
            hasSpecial: /[!@#$%^&*(),.?":{}|<>]/.test(userData.password),
        });
    }, [userData.password]);
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div className="mt-2">
                                        ...
                                        {errorMsg && (
                                            <div className="text-red-800 bg-red-200 p-2 flex justify-center rounded-md mt-2">
                                                {errorMsg}
                                            </div>
                                        )}
                                    </div>
                        ...
                        <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 gap-5">
                            ...
                            <button
                                ...
                                disabled={isLoading}
                                className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-red-300 hover:text-red-800 sm:mt-0 sm:w-auto disabled:opacity-50"
                            >
                                Cancel
                            </button>
                        </div>
