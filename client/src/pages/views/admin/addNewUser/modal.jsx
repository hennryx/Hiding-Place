        ...
        <Dialog open={isOpen} onClose={setIsOpen} className="relative z-10">
            ...
            <div className="fixed top-[10%] z-10 w-screen overflow-y-auto">
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    ...
                    >
                        {/* Add max-height and overflow-y-auto to the content container */}
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div className="mt-2">
                                        ...
                                        {errorMsg && (
                                            <div className="text-red-800 bg-red-200 p-2 flex justify-center rounded-md">
                                                {errorMsg}
                                            </div>
                                        )}
                                    </div>
                        ...
                        <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 gap-5">
                            <button
                                ...
                                className="inline-flex w-full justify-center rounded-md px-3 py-2 text-sm font-semibold bg-[var(--primary-color)] text-[var(--text-primary-color)] hover:bg-[var(--primary-hover-color)] sm:ml-3 sm:w-auto shadow-xs"
                            >
