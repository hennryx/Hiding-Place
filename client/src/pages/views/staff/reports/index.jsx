...
const tableHeader = [
    {
        key: "SALE",
        header: ["Date", "Product", "Quantity", "Total", "Staff"],
    },
    {
        key: "PURCHASE",
        header: ["Date", "Supplier", "Products", "Total Items", "Staff"],
    },
    {
        key: "RETURN",
        header: ["Date", "Product", "Quantity", "Reason", "Staff"],
    },
    {
        key: "INVENTORY",
        header: ["#", "Product Name", "Size", "Price", "Stock"],
    },
];
...
const Reports = () => {
    ...
    const { salesData: transactionsData, getTransactionSales } =
    ...
    useEffect(() => {
        if (token) {
            ...
            getTransactionSales(
                { startOfDate: startDate, endOfDate: endDate, type: "SALE" },
                token
            );
        }
    }, [token]);
    ...
    const generatePDF = async () => {
        ...
        try {
            const pdfUtils = await import(
                "../../../../services/utilities/pdfUtils"
            );
        ...
        try {
            ...
            if (reportType === "sales") {
                ...
                formattedData = filteredData.map((item) => ({
                    ...
                    total: item.products
                        .map((p) => p.quantity * (p.product?.sellingPrice || 0))
                        .reduce((a, b) => Number(a) + Number(b), 0),
                }));
        ...
        <div className="container p-4">
            <div className="flex flex-col gap-5">
                ...
                <div className="bg-white rounded-lg shadow-md p-4">
                    ...
                    <div
                        ref={reportTableRef}
                        className="overflow-x-auto bg-white shadow-inner rounded-lg"
                    >
