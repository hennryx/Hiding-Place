...
const Notification = () => {
    ...
    const { getNotifications, connectSocket, disconnectSocket, data } =
                ...
                <div className="w-full flex gap-2">
                    ...
                    >
                        <span className="text-xs">
                            All({data.filter((n) => !n.isArchived).length})
                        </span>
                    </div>
                    <div
                        className={`p-2 rounded-md cursor-pointer ${
                    ...
                    >
                        <span className="text-xs">
                            Archived({data.filter((n) => n.isArchived).length})
                        </span>
                    </div>
                </div>
